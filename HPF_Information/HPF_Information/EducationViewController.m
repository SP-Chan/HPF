...
- (void)viewDidLoad {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://c.m.163.com/nc/article/list/T1348654225495/%@.html",str];
...
-(void)requestData:(NSString *)string
{
    ...
    [NetworkRequestManager requestWithType:GET urlString:string ParDic:nil Header:nil finish:^(NSData *data) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
            ...
            NSArray *array = [dataDic objectForKey:@"T1348654225495"];
...
-(void)loadNewData
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://c.m.163.com/nc/article/list/T1348654225495/0-20.html"];
