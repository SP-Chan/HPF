...
#import "VogueViewController.h"
#import "NetworkRequestManager.h"
#import "MJRefresh.h"
#import "MJRefreshAutoFooter.h"
#import "ThreeImageCell.h"
#import "ScrollViewController.h"
@interface VogueViewController ()
{
...
@implementation VogueViewController
...
- (void)viewDidLoad {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://c.m.163.com/nc/article/list/T1348650593803/%@.html",str];
...
-(void)requestData:(NSString *)string
{
    ...
    [NetworkRequestManager requestWithType:GET urlString:string ParDic:nil Header:nil finish:^(NSData *data) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
            ...
            NSArray *array = [dataDic objectForKey:@"T1348650593803"];
...
-(void)loadNewData
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://c.m.163.com/nc/article/list/T1348650593803/0-20.html"];
