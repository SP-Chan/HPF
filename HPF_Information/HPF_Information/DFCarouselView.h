...
//  Copyright © 2016年 邓方. All rights reserved.
//

#import <UIKit/UIKit.h>
@class DFCarouselView;

typedef void(^ClickBlock)(NSInteger index);

@protocol DFCarouselViewDelegate <NSObject>
/**
 ...
 *  @param index        图片索引
 */
- (void)carouselView:(DFCarouselView *)carouselView didClickImage:(NSInteger)index;

@end


@interface DFCarouselView : UIView
/*
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<DFCarouselViewDelegate> delegate;
